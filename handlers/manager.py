...
# ==================================================
# ENTRY POINT (вызывается из main.py /start router)
# ==================================================
...
async def on_premium_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # НЕ ждём ввод → просто возвращаем панель
